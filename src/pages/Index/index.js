...
export default class Index extends React.Component {
    ...
    renderFlexItem () {
        return navs.map(item =>
            <Flex.Item key={item.id} onClick={() => { this.props.history.push(item.path); this.props.history.go(0) }}>
    ...
    render () {
        return (
            <div className='index'>
                ...
                <Grid className="group-list" data={this.state.groups} columnNum={2} hasLine={false} square={false} renderItem={(item) => (
